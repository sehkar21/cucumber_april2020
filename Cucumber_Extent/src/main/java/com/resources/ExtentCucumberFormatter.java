 ...
 */
public class ExtentCucumberFormatter extends BaseClass implements Reporter, Formatter {
	...
	try {
		stepTestThreadLocal.get().fail(result.getErrorMessage(),MediaEntityBuilder.createScreenCaptureFromPath("." +getScreenshot()).build());
	} catch (IOException e) {
